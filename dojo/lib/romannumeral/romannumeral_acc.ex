defmodule RomannumeralAcc do
  ...
  defp convert(input, acc) when input >=500 do
    convert(input-500, ["D"|acc])
  end

  defp convert(input, acc) when input >=400 do
    convert(input-400, ["CD"|acc])
  end

  defp convert(input, acc) when input >=100 do
    convert(input-100, ["C"|acc])
  end

  defp convert(input, acc) when input >=90 do
    convert(input-90, ["XC"|acc])
  end
